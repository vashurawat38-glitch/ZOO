...
function Home() {
  return (
    <section 
      id="home" 
      className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-green-100 to-green-200 text-center p-4"
    >
      <h2 className="text-4xl md:text-5xl font-extrabold mb-6">Welcome to Our Zoo 🦁</h2>
